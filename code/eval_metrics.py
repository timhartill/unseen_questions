...
def parse_mixture(mixture):
    ...
    for ds in mixturelist:
        ...
        elif ds == 'q_ret_paras_all_v3':
            unified_dataset.extend(q_ret_paras_train_v3)
        elif ds == 'q_ret_paras_maxp4_all_v3':
            unified_dataset.extend(q_ret_paras_maxp4_train_v3)
        elif ds == 'q_llm_expl_all':
            unified_dataset.extend(q_llm_expl_train)    
        elif ds == 'q_llm_expl_paras_all':
            unified_dataset.extend(q_llm_expl_paras_train)    
        elif ds == 'q_expl_all':
            unified_dataset.extend(q_expl_train)    
        else:
