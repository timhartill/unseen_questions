...
# $UQA_DIR/csqa2/dev.tsv          $UQA_DIR/csqa2/train.tsv
# $UQA_DIR/creak_od_ans/dev.tsv   $UQA_DIR/creak_od_ans/train.tsv
...
python mdr_searchers.py \
    --prefix SCI_ITER_scifullabstracts_sciencoderv2_claimstest_test8 \
    ...
    --init_checkpoint_stage1 $LDATA/out/mdr/logs/stage1_sciencoderv2_test1-01-06-2023-rstage1-seed42-bsz12-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8/checkpoint_best.pt \
    --init_checkpoint_stage2 $LDATA/out/mdr/logs/stage2_sciencoderv2_test1-01-06-2023-rstage2-seed42-bsz12-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8/checkpoint_best.pt \
    --gpu_model \
    --gpu_faiss \
