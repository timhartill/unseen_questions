...
# RR Model training using merged ratioanles + iter contexts + extra relevance rationales train filea
...
python rr_train.py \
    --do_train \
    --prefix RR_test7_mcstrip0.5_notsinglepossplit_withsharednormal_additer_addxtrarelrats \
