...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV31_TEST11_CSQA_svint8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV31_TEST12_SQA_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV31_TEST13_ARCDA_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV31_TEST14_IIRC_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV31_TEST15_MU_DEV_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
