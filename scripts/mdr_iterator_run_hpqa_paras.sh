...
python mdr_searchers.py \
    --prefix ITER_hpqaabst_hovereval_test32_beam25_maxh4_hpqahovnqmubs150 \
    --output_dir $LDATA/out/mdr/logs \
    --predict_file $HDATA/data/baleen_downloads/hover/hover_qas_val_with_spfacts.jsonl \
    --index_path $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test10_6gpubs150-08-30-202/index.npy \
    --corpus_dict $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test10_6gpubs150-08-30-202/id2doc.json \
    --model_name roberta-base \
    --init_checkpoint $LDATA/out/mdr/logs/hover_hpqa_nq_mu_paras_test10_6gpubs150-08-30-2022-nomom-seed16-bsz150-fp16True-lr2e-05-decay0.0-warm0.1-valbsz100-sharedTrue-ga1-varTrue-cenone/checkpoint_best.pt \
