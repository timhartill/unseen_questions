...
python mdr_searchers.py \
    ...
    --index_path $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test5-07-20-2022-nomom/index.npy \
    --corpus_dict $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test5-07-20-2022-nomom/id2doc.json \
    --model_name roberta-base \
