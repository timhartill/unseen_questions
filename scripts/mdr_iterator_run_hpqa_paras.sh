...
python mdr_searchers.py \
    --prefix ITER_hpqaabst_hovereval_test33_beam25_maxh4_hpqahovnqmubs150_mom \
    --output_dir $LDATA/out/mdr/logs \
    --predict_file $HDATA/data/baleen_downloads/hover/hover_qas_val_with_spfacts.jsonl \
    --index_path $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test11_mom_6gpubs150_hgx2-09-01-2022/index.npy \
    --corpus_dict $LDATA/out/mdr/encoded_corpora/hover_hpqa_nq_mu_paras_test11_mom_6gpubs150_hgx2-09-01-2022/id2doc.json \
    --model_name roberta-base \
    --init_checkpoint $LDATA/out/mdr/logs/hover_hpqa_nq_mu_paras_test11_mom_6gpubs150_hgx2-09-01-2022-mom-seed16-bsz150-fp16True-lr1e-05-decay0.0-warm0.1-valbsz100-m0.999-k76800-t1.0-ga1-varTrue-cenone/checkpoint_q_last.pt \
