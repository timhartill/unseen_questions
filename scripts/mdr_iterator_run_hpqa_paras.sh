...
python mdr_searchers.py \
    --prefix ITER_fullwiki_nqopendev_test51_b60_h4_hpqahovnqmubs250_mom \
    --output_dir $LDATA/out/mdr/logs \
    --output_dataset $UQA_DIR/nq_open_fullwiki_bs60/dev.tsv \
    --predict_file $UQA_DIR/nq_open_od_ans/dev.tsv \
