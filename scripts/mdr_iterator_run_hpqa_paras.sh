...
python mdr_searchers.py \
    --prefix ITER_fullwiki_creaktrain_test48_b150_h4_hpqahovnqmubs250_mom \
    --output_dir $LDATA/out/mdr/logs \
    --output_dataset $UQA_DIR/creak_fullwiki_bs150_implrel/train.tsv \
    --predict_file $UQA_DIR/creak_od_ans_impl_rels/train.tsv \
