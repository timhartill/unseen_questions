...
# here using rr model: RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5
# rather than RR_test5_mcstrip0.5_notsinglepossplit_withsharednormal_additer-05-01-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5
# added     --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST6_CSQA_svfp16 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST7_SQA_svfp16 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST8_ARCDA_svfp16 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST9_IIRC_svfp16 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST10_MU_DEV_svfp16 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST11_CSQA_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST12_SQA_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST13_ARCDA_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST14_IIRC_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST15_MU_DEV_svint8 \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
echo "Running for BLOOM INT8..."

python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST1_CSQA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST2_SQA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST3_ARCDA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST4_IIRC \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGEV3_TEST5_MU_DEV \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test8_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer_addxtrarelrats-06-08-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposTrue-mcstrip0.5/checkpoint_best.pt \
    --rr_version v3t8 \
