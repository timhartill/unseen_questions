...
python cli.py --do_train --output_dir $LDATA/out/mdr/logs/UQA_s14_v3_from_s9_v2_base_add_exp_gold_only \
        ...
        --mixture q_paras_all,q_paras_noanswer_all,q_mc_all,q_mc_paras_all,q_od_all,tt_all,poet_all,synth_num_all,synthetic_textual,enwiki_20200801_selfsvised,q_expl_all
