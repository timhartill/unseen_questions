...
echo "BUILD CONTEXT FOR IIRC INITIAL CONTEXT TRAIN..."
python mdr_searchers.py \
    --prefix ITER_fullwiki_us_iircictrain_test90_b60_h4_hpqahovnqmubs250_mom \
    --output_dir $LDATA/out/mdr/logs \
    --output_dataset $UQA_DIR/iirc_initial_context_fullwiki_bs60/train.tsv \
    --predict_file $UQA_DIR/iirc_initial_context/train.tsv \
