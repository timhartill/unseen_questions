...
# On 1 gpu bs 250 takes ~8.5GB. Time approx 6hrs on gpu running 1 other job.
...
python mdr_encode_corpus_nativeamp.py \
    ...
    --embed_save_path /home/thar011/data/mdr/hpqa_varinitialtest2_03-26_bs24_no_momentum \
    --fp16 \
    --max_c_len 300 \
    --num_workers 20
