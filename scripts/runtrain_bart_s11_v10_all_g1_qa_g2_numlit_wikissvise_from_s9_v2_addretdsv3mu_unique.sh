...
# substitute unique answer versions of mu dev fullwiki for non-unique version in training mix
...
python cli.py --do_train --output_dir $LDATA/out/mdr/logs/UQA_s11_v10_all_g1_qa_g2_numlit_wikissvise_from_s9_v2_addretdsv3mu_unique \
        --is_unifiedqa \
        ...
        --mixture q_paras_all,q_paras_noanswer_all,q_mc_all,q_mc_paras_all,q_od_all,tt_all,poet_all,synth_num_all,synthetic_textual,enwiki_20200801_selfsvised,q_ret_paras_all_v3,q_ret_paras_maxp4_all_v3
