...
python rr_train.py \
    --do_train \
    --prefix RR_test6_mcstrip0.5_WITHsinglepossplit_withsharednormal_additer \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --train_batch_size 24 \
    --learning_rate 5e-5 \
    --fp16 \
    --train_file $HDATA/data/rationale_reranker/rr_train_rat_iterctxtsv3_merged.jsonl \
    --predict_file $HDATA/data/rationale_reranker/rr_dev_rat_iterctxtsv3_merged.jsonl \
    --seed 42 \
    --eval-period 2000 \
    --max_c_len 512 \
    --max_q_len 70 \
