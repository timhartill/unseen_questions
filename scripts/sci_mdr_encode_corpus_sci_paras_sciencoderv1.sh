...
python mdr_encode_corpus_nativeamp.py \
    ...
    --predict_file $HDATA/data/SCI/sci_corpus_paras_with_sent_spans.jsonl \
    ...
    --embed_save_path $LDATA/out/mdr/encoded_corpora/sci_paras_c300_sciencoderv1_test2_mom_6gpubs250 \
    --use_var_versions \
    --fp16 \
    --max_c_len 300 \
    --num_workers 10
