...
python mdr_searchers.py \
    --prefix SCI_ITER_scifullabstracts_claimstest_test4 \
    --output_dir $LDATA/out/mdr/logs \
    --output_dataset $UQA_DIR/claims_test_scifullabstracts_bs150/test.tsv \
    --predict_file $UQA_DIR/claims_test/test.tsv \
    --index_path $LDATA/out/mdr/encoded_corpora/sci_full_abstract_c300_test12_mom_6gpubs250/index.npy \
    --corpus_dict $LDATA/out/mdr/encoded_corpora/sci_full_abstract_c300_test12_mom_6gpubs250/id2doc.json \
    --model_name roberta-base \
