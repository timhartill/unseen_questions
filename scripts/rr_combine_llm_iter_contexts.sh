...
# Score llm & iter rationales/contexts using rr model and output tsv datasets based on rr (and ev) scores
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGE_TEST1_CSQA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test4_mcstrip0.5_notsinglepossplit_withsharednormal-04-11-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5/checkpoint_best.pt \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGE_TEST2_SQA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test4_mcstrip0.5_notsinglepossplit_withsharednormal-04-11-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5/checkpoint_best.pt \
    --output_dir $LDATA/out/mdr/logs \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGE_TEST3_ARCDA \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test4_mcstrip0.5_notsinglepossplit_withsharednormal-04-11-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5/checkpoint_best.pt \
    --output_dir $LDATA/out/mdr/logs \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGE_TEST4_IIRC \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test4_mcstrip0.5_notsinglepossplit_withsharednormal-04-11-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5/checkpoint_best.pt \
    --output_dir $LDATA/out/mdr/logs \
...
python rr_merge_iter_output_eval.py \
    --prefix RR_LLM_ITER_MERGE_TEST5_MU_DEV \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
    --init_checkpoint $LDATA/out/mdr/logs/RR_test4_mcstrip0.5_notsinglepossplit_withsharednormal-04-11-2023-RR-seed42-bsz24-fp16True-lr5e-05-decay0.0-warm0.1-valbsz100-ga8-nopairFalse-singleposFalse-mcstrip0.5/checkpoint_best.pt \
    --output_dir $LDATA/out/mdr/logs \
