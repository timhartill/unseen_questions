...
# EVAL RR, S1 & S2 Models on StrategyQA facts for relevance


cd ../code

python rr_eval_rationalerelevance_sqafacts.py \
    --prefix RRSQA_RAT_REL_TEST1_RR \
...
python rr_eval_rationalerelevance_sqafacts.py \
    --prefix RRSQA_RAT_REL_TEST2_S1_Para_ReRanker \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
...
python rr_eval_rationalerelevance_sqafacts.py \
    --prefix RRSQA_RAT_REL_TEST3_S2_EvidenceSetScorer \
    --predict_batch_size 100 \
    --model_name google/electra-large-discriminator \
