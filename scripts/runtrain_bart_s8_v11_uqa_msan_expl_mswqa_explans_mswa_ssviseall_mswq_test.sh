...
python cli.py --do_train --output_dir /large_data/thar011/out/mdr/logs/UQA_s8_v11_bartlg_uqa_msan_expl_mswqa_explans_mswa_ssviseall_mswqTST \
        --is_unifiedqa \
